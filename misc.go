...
func wrapObject(v Value) interface{} {
	...
	case "RTCCertificate":
		return wrapRTCCertificate(v)
	case "RTCConfiguration":
		return wrapRTCConfiguration(v)
	case "RTCDataChannel":
		return wrapRTCDataChannel(v)
	case "RTCDataChannelEvent":
		return wrapRTCDataChannelEvent(v)
	case "RTCDtlsFingerprint":
		return wrapRTCDtlsFingerprint(v)
	case "RTCDtlsTransport":
		return wrapRTCDtlsTransport(v)
	case "RTCDTMFSender":
		return wrapRTCDTMFSender(v)
	case "RTCDTMFToneChangeEvent":
		return wrapRTCDTMFToneChangeEvent(v)
	case "RTCError":
		return wrapRTCError(v)
	case "RTCErrorEvent":
		return wrapRTCErrorEvent(v)
	case "RTCIceCandidate":
		return wrapRTCIceCandidate(v)
	case "RTCIceCandidateInit":
		return wrapRTCIceCandidateInit(v)
	case "RTCIceCandidatePair":
		return wrapRTCIceCandidatePair(v)
	case "RTCIceParameters":
		return wrapRTCIceParameters(v)
	case "RTCIceServer":
		return wrapRTCIceServer(v)
	case "RTCIceTransport":
		return wrapRTCIceTransport(v)
	case "RTCPeerConnection":
		return wrapRTCPeerConnection(v)
	case "RTCPeerConnectionIceErrorEvent":
		return wrapRTCPeerConnectionIceErrorEvent(v)
	case "RTCPeerConnectionIceEvent":
		return wrapRTCPeerConnectionIceEvent(v)
	case "RTCRtcpParameters":
		return wrapRTCRtcpParameters(v)
	case "RTCRtpCapabilities":
		return wrapRTCRtpCapabilities(v)
	case "RTCRtpCodecCapability":
		return wrapRTCRtpCodecCapability(v)
	case "RTCRtpCodecParameters":
		return wrapRTCRtpCodecParameters(v)
	case "RTCRtpCodingParameters":
		return wrapRTCRtpCodingParameters(v)
	case "RTCRtpContributingSource":
		return wrapRTCRtpContributingSource(v)
	case "RTCRtpDecodingParameters":
		return wrapRTCRtpDecodingParameters(v)
	case "RTCRtpEncodingParameters":
		return wrapRTCRtpEncodingParameters(v)
	case "RTCRtpHeaderExtensionCapability":
		return wrapRTCRtpHeaderExtensionCapability(v)
	case "RTCRtpHeaderExtensionParameters":
		return wrapRTCRtpHeaderExtensionParameters(v)
	case "RTCRtpParameters":
		return wrapRTCRtpParameters(v)
	case "RTCRtpReceiveParameters":
		return wrapRTCRtpReceiveParameters(v)
	case "RTCRtpReceiver":
		return wrapRTCRtpReceiver(v)
	case "RTCRtpSender":
		return wrapRTCRtpSender(v)
	case "RTCRtpSendParameters":
		return wrapRTCRtpSendParameters(v)
	case "RTCRtpSynchronizationSource":
		return wrapRTCRtpSynchronizationSource(v)
	case "RTCRtpTransceiver":
		return wrapRTCRtpTransceiver(v)
	case "RTCSctpTransport":
		return wrapRTCSctpTransport(v)
	case "RTCSessionDescription":
		return wrapRTCSessionDescription(v)
	case "RTCSessionDescriptionInit":
		return wrapRTCSessionDescriptionInit(v)
	case "RTCStatsEvent":
		return wrapRTCStatsEvent(v)
	case "RTCStatsReport":
		return wrapRTCStatsReport(v)
	case "RTCTrackEvent":
		return wrapRTCTrackEvent(v)
	case "Screen":
		return wrapScreen(v)
	case "ShadowRoot":

...
type (
	...
	*/
	...
	WebGLRenderingContextBase interface {
		...
		BlendColor(float64, float64, float64, float64)
		...
		BufferDataSource(GLenum, ArrayBufferView, GLenum)
		BufferSubData(GLenum, int, ArrayBufferView)
		CheckFramebufferStatus(GLenum) GLenum
		Clear(uint)
		ClearColor(float64, float64, float64, float64)
		ClearDepth(float64)
		ClearStencil(int)
		...
		TexParameterf(GLenum, GLenum, float64)
		...
		Uniform1f(WebGLUniformLocation, float64)
		Uniform2f(WebGLUniformLocation, float64, float64)
		Uniform3f(WebGLUniformLocation, float64, float64, float64)
		Uniform4f(WebGLUniformLocation, float64, float64, float64, float64)
		...
		Uniform1fv(WebGLUniformLocation, []float64)
		Uniform2fv(WebGLUniformLocation, []float64)
		Uniform3fv(WebGLUniformLocation, []float64)
		Uniform4fv(WebGLUniformLocation, []float64)
		...
		UniformMatrix2fv(WebGLUniformLocation, bool, []float64)
		UniformMatrix3fv(WebGLUniformLocation, bool, []float64)
		UniformMatrix4fv(WebGLUniformLocation, bool, []float64)
		UseProgram(WebGLProgram)
		ValidateProgram(WebGLProgram)
		VertexAttrib1f(uint, float64)
		VertexAttrib2f(uint, float64, float64)
		VertexAttrib3f(uint, float64, float64, float64)
		VertexAttrib4f(uint, float64, float64, float64, float64)
		VertexAttrib1fv(uint, []float64)
		VertexAttrib2fv(uint, []float64)
		VertexAttrib3fv(uint, []float64)
		VertexAttrib4fv(uint, []float64)
